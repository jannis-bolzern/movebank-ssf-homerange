...
All Movebank data sets have the same schema. This simplifies data handling and enables code re-use. A library for data processing and trajectory handling in R is provided by @kranstauber2024move2. The R code for Movebank data download, preprocessing, and partly visualization can be found the the following documents: [UK wader nesting season home range](preprocessing_uk_wader_nesting_season_home_range.qmd), [montly home range](preprocessing_monthly_home_ranges.qmd).
...
![Data points per year](year_count.png){#fig-datapoints-year}
...
![Data points per month](month_count.png){#fig-datapoints-month}
