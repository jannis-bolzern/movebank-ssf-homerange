...
We have performed spatial data analysis and statistics on externally contributed publicly available data to demonstrate that human activity influences animal behavior significantly. We could show that fox home range sizes are much larger in remote areas, and that forests are preferred over built-up areas for habitat selection depending on human footprint. 
