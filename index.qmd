...
1.  Home Range Implications: Do animals exhibit smaller home ranges in high human impact areas? This is examined by comparing red fox (vulpes vulpes) home ranges in low and high human impact areas.
2.  Habitat Selection in Human-Dominated Landscapes: How do animals select habitats under varying levels of human influence? This is analysed based on bobcat (lynx rufus) and coyote (canis latrans) data from a national park area.
...
The data sampling intervals are intended to be four hours. In practice, the intervals are irregular with many outliers. They differ for the two species with the bobcat intervals being less dense and regular in comparisong. @fig-bobcat-coyote-sampling shows a boxplot for the sampling intervals. Outliers are removed for readability. 
