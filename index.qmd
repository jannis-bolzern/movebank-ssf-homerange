...
Similar differences in order of magnitude between remote and rural fox home ranges can also be observed for the monthly home range results @fig-home-ranges-boxplot. Outliers are removed, in particular the irregular data for Herschel (as seen in @fig-herschel-map).
