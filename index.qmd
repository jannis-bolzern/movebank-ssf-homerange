...
The data sampling intervals are intended to be four hours. In practice, the intervals are irregular with many outliers and they differ for the two species. @fig-bobcat-coyote-sampling shows a boxplot for the sampling intervals, with outliers removed since the chart would be unreadable otherwise. Since the coyote sampling interval is more regular compared to the bobcat data, the analysis was performed on coyote data only. 
