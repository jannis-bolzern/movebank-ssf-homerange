...
Looking at the breakdowns by month as shown in @fig-datapoints-month shows seasonal differences in the amount of data available. 
...
#| echo: false
#| warning: false
ggplot(month_count, aes(x = as.factor(month), y = count, color = source)) +
  geom_point() +
  #scale_x_continuous(breaks = 1:12, labels = 1:12) +
  #scale_x_discrete(expand = c(50, 0)) +
  facet_wrap(~ ifelse(source %in% c("Bylot", "Herschel"), "Bylot/Herschel", "Wiltshire"), scales = "free_y") +
