...
1. Access to Anthropogenic Food Sources: Do animals exhibit smaller home ranges in high human-impact areas ?
...
For the human footprint data, the global 100 meter resolution terrestrial human footprint data (HFP-100) by @gassert2023operational was chosen.

For land use, the ESA WorldCover data [link](https://esa-worldcover.org/en) is preferred.
...
The ESA WorldCover 2021 data at 10m resolution is downloaded via the Microsoft Planetary Computer STAC API [link](https://planetarycomputer.microsoft.com/docs/quickstarts/reading-stac/) for simple programmatic access in R.
