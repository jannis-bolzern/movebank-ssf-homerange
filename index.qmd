...
![Bobcat and coyote locations in the context of the land cover data](img/esa_landcover_study_area_with_animals_adj.png){#fig-esa width="75%"}

![HFP-100 data with bobcat and coyote tracks](img/hfp_adj_rw.png){#fig-hfp width="75%"}
