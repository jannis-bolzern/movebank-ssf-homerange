...
We can conclude that finding the selection of best data points to compare involves a complex choice. It is highly likely that this choice will influence the results. The amount of influence on the results will depend on the use case. This is why we will discuss it as part of section @sec-methodology.
=======
...
>>>>>>> 35a92f5c3796d3360af08c56d351a516a63a6aea
...
the first goal is to perform the simplest acceptable comparison. But what is that?
