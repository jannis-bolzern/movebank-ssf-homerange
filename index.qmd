...
```{r}
#EPSG:3154 NAD83(CSRS) / UTM zone 7N Herschel Island, also known as Qikiqtaruk, is located at approximately 69°35'23" N, 139°05'57" W
#Bylot island is split over two UTM zones #EPSG:2958 NAD83(CSRS) / UTM zone 17N \# NAD83(CSRS) / UTM zone 18N #This covers them both: EPSG:3347 NAD83 / Statistics Canada Lambert
```
...
::: {#fig-wiltshire-map .quarto-figure}
#<iframe src="img/wiltshire_map.html" width="100%" height="600px" frameborder="0">
...
#<iframe src="img/bylot_map.html" width="100%" height="600px" frameborder="0">
...
#<iframe src="img/herschel_map.html" width="100%" height="600px" frameborder="0">
