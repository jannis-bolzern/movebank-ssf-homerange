...
The bobcat and coyote data from @prugh2023fear contains data for 29 coyotes and 30 bobcats collected between June 2018 and June 2022. They reside in two separated geographical areas and have species-interspersed home ranges. TBD some animal were filtered out, describe why.
...
The data sampling intervals are intended to be four hours. In practice, they are irregular with many outliers, and differ between the two species. The bobcat intervals are less dense and less regular in comparison. @fig-bobcat-coyote-sampling shows a boxplot for the sampling intervals. Outliers are removed for readability. 
