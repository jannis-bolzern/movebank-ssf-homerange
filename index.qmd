...
According to @rykiel1996testing, model validation means demonstrating that a model is acceptable for its intended use because it meets specified performance requirements. The purpose, criteria, and context of the model must be specified.

Two models: Data + home range calculation
