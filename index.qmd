...
![Home ranges for Bylot foxes (March 15th to June 15th, 2012)](home_range_bylot_wader.png){#fig-home-ranges-bylot}

![Home ranges for Wiltshire foxes (March 15th to June 15th, 2019)](home_range_wiltshire_wader.png){#fig-home-ranges-wiltshire}

![Home ranges for Wiltshire foxes (March 15th to June 15th, 2019, 24 hour sampling interval)](home_range_wiltshire_wader_sampled.png){#fig-home-ranges-wiltshire-sampled24h}
...
library("readr")
library("dplyr")
results_bylot <- read_delim("data/output_bylot.csv", delim = ";", col_types = cols(
  areas = col_double()))
