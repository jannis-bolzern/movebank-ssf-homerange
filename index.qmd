...
The bobcat (Lynx rufus) and coyote (Canis latrans) data from @prugh2023fear for remote areas with some rural structures in northern Washington, US contains data for 29 coyotes and 30 bobcats. Sampling intervals are variable and different for the two species as shown in @fig-bobcat-coyote-mean-sampling.

![Mean sampling rates for bobcat and coyote data](img/bobcat_coyote_mean_sampling_rates.png){#fig-bobcat-coyote-mean-sampling}

### Human footprint data

@fig-hfp shows a plot of the extracted human footprint data. It was projected to the WGS84 geographic coordinate system (EPSG:4326).

![HFP-100 data with bobcat and coyote tracks shown in black and relevant area in red](img/hfp.png){#fig-hfp}

### Land cover data

@fig-esa shows a plot of the extracted land cover data.

![Relevant ESA WorldCover data with bobcat and coyote tracks shown in black](img/esa_landcover_study_area.png){#fig-esa}
