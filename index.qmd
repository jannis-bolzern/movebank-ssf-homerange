...
#| include: false
remove_outliers <- function(areas) {
...
@fig-home-ranges-boxplot shows a comparison of monthly home ranges.
...
boxplot(
  remove_outliers(convert_m2_to_km2(results_bylot$results_bylot.areas)), 
  remove_outliers(convert_m2_to_km2(results_herschel$results_herschel.areas)), 
  remove_outliers(convert_m2_to_km2(results_wiltshire$results_wiltshire.areas)), 
  xlab = "", 
  ylab = expression("Home range in " *  km^2))
