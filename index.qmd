...
1. We limited analyses to the same seasonal period (March 15th – June 15th) across datasets to control for seasonal variation.
...
Due to limited data from Herschel Island (@fig-datapoints-month), meaningful comparison with Wiltshire was not feasible. Therefore, we focused comparative analyses on the Wiltshire and Bylot datasets.
...
![Relationship between human footprint and movement. The red line marks the 95% density contour, encompassing 95% of observed steps.](img/coyote_EDA_hexbin.png){#fig-coy-eda-hex width="100%" .lightbox}
