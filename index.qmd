...
#### Movebank
We have used data from the Movebank database by @kays2022movebank. All Movebank data sets have the same format and table definitions. This simplifies data handling since it allows to re-use R code. A library for data processing and trajectory handling in R is provided by @bartk_move2.
...
TBD: This is for charts and results only.

### Research question 1

TBD: This should only be results.
...
The fox home range results differ enormously between rural and remote areas. The influence of technical aspects like sampling intervals plays a secondary role in comparison. We can conclude that human presence massively impacts fox behavior based availability of food, but other factors such as human presence. We are not able to distinguish between these influences.
