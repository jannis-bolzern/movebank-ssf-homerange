...
For land use, the ESA WorldCover 10m 2021 data [link](https://esa-worldcover.org/en) is accessed via the Microsoft Planetary Computer STAC API [link](https://planetarycomputer.microsoft.com/docs/quickstarts/reading-stac/) for simple programmatic access in R.
