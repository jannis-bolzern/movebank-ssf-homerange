...
Different data sets will be used for each research question. Relying on Movebank data, as described in @sec-movebank, presents additional challenges stemming from the fact that the data will be used for purposes it was not originally collected for.
