...
We analyzed four animal tracking datasets obtained from the Movebank database @kays2022movebank, including red fox (*Vulpes vulpes*) tracks from Wiltshire, UK @porteus2024movement, Bylot Island, Canada, and Herschel Island, Canada @lai2022red, as well as bobcat (*Lynx rufus*) and coyote (*Canis latrans*) tracks from northeastern Washington, USA @prugh2023fear. The tracking data varied in temporal resolution and geographic context, with sample sizes and data characteristics summarized in Table X.

| Dataset    | Species        | Location        | Year(s)     | N animals | Sampling interval       | Total fixes |
|------------|----------------|----------------|-------------|-----------|-----------------------|-------------|
| Wiltshire  | Red fox        | Wiltshire, UK   | 2016–2019   | 35        | 10–60 min              | 146072       |
| Bylot      | Red fox        | Bylot Island    | 2011–2015   | 2         | 1/day (afternoon)      | 2086         |
| Herschel   | Red fox        | Herschel Island | 2009–2010   | 2         | 1/day (afternoon)      | 223         |
| Washington | Coyote         | NE Washington   | 2014–2015   | 34 (coyotes), 36 (bobcats)| 4-hour programmed      | 121706       |
...
![HFP-100 data with bobcat and coyote tracks](img/hfp.png){#fig-hfp width="100%" .lightbox}

Although all GPS collars were programmed to record locations at four-hour intervals, the actual sampling was irregular and included numerous outliers (@fig-sampling-rates). Sampling intervals for bobcats were particularly sparse and inconsistent compared to those for coyotes.
...
![Human footprint distribution by land cover type](img/coyote_EDA_ridgeline.png){#fig-coy-eda-ridge width="100%" .lightbox}
...
![Relationship between movement and human footprint](img/coyote_EDA_hexbin.png){#fig-coy-eda-hex width="100%" .lightbox}
...
![Average marginal effects (± 95% confidence intervals) of human footprint on coyote habitat selection across land cover types. Plots quantify the relative change in log selection probability across the range of human footprint, while averaging over other covariates. Positive values indicate above-average selection, negative values indicate below-average selection. Vertical dashed lines indicate estimated human footprint values at peak selection.](img/avg_effect.png){#fig-avg-eff width="100%" .lightbox}
...
![Variation in human footprint across and cover types](img/coyote_EDA_boxplot.png){#fig-coy-eda-box width="100%" .lightbox}
...
- Red fox: UK wader nesting season home ranges: [link](https://elkeelke.github.io/MovebankProject/preprocessing_uk_wader_nesting_season_home_range.html)
- Red fox: monthly home ranges: [link](https://elkeelke.github.io/MovebankProject/preprocessing_monthly_home_ranges.html)
- Bobcat/coyote: data preparation and statistical modelling: [link](https://elkeelke.github.io/MovebankProject/preprocessing_SSF_complete.html)
- Human Footprint Index data preparation: [link](https://elkeelke.github.io/MovebankProject/preprocessing_HFP_subsetting.html)
- ESA WorldCover data preparation: [link](https://elkeelke.github.io/MovebankProject/preprocessing_ESA_world_cover.html)
