...
The red fox data is used for home range assessment for rural and remote locations. Home range sizes are calculated using minimum convex polygons. This provides estimates of the area used by each individual animal that are easy to compare to each other.
