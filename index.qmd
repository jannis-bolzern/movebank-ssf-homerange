...
According to @rykiel1996testing, model validation means demonstrating that a model is acceptable for its intended use because it meets specified performance requirements.

purpose, criteria, and context of the model must be specified

CRS Explorer [link](https://crs-explorer.proj.org/)

Use UTM coordinates for both areas

Herschel island is much smaller: 116 km<sup>2</sup>
...
Bylot island is much bigger: 11.067 km<sup>2</sup>
It is split over two UTM zones
...
Interactive map of Bylot Island with high level view of GPS tracks (unfiltered).
:::

::: {.quarto-figure #fig-herschel-map}
<iframe src="img/herschel_map.html" width="100%" height="600px" frameborder="0"></iframe>
Interactive map of Herschel Island with high level view of GPS tracks (unfiltered), some of them irregular.
:::
