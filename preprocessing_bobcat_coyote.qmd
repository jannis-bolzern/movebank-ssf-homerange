...
# Load, inspect, and prepare tracking data
```{r}
...
# Export re-sampled step data
saveRDS(coyote1, "data/coyote_resampled.rds")
saveRDS(bobcat1, "data/bobcat_resampled.rds")
```

# Read and recalculate step length
```{r}
#'
#' Recalculate steps.
#'
#' This function takes the step coordinates created with amt and recalculates
#' the step lengths in meters.
#'
#' @param file The filename that stores the re-sampled step data
#'
#' @return The data
#' @export
...
# Note that land use and land cover are the same thing.
...
#'
#' This function adds land use data and human footprint data for each row.
#'
#' @param df The data frame to mutate
#'
#' @return The data
#' @export
...
#' Prepare SSF data.
#'
#' This function prepares the data to serialize as the input to the statistical
#' modelling.
#'
#' @param df The data frame to mutate
#'
