---
title: "preprocessing_monthly_home_ranges"
format: html
---
...
calculate_monthly_home_ranges <- function(ts_start, num_months, study_id, license_string_with_quotes) {
  ...
  for (i in 1:num_months) {
    ...
    tryCatch({
      ...
      # in practice sind some of the studies ran only for parts of the year.
...
results_bylot <- calculate_monthly_home_ranges(as.POSIXct("2011-07-01 00:00:00"), 54, 1371322147, '9559cb1b1cca51e9f3fd69812e5e22dc')
write_csv(data.frame(results_bylot$areas), "output_bylot.csv")

results_herschel = calculate_monthly_home_ranges(as.POSIXct("2009-07-01 00:00:00"), 18, 1371529289, '436e8205d0c2973115e2024b146a6ad5')
write_csv(data.frame(results_herschel$areas), "output_herschel.csv")

results_wiltshire = calculate_monthly_home_ranges(as.POSIXct("2016-01-01 00:00:00"), 48, 3179890710, 'ffa36f79defe10eac9fe70f6502a17e0')
write_csv(data.frame(results_wiltshire$areas), "output_wiltshire.csv")
```
