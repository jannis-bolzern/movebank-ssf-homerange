...
ggplot() +
  ...
  scale_fill_manual(
    values = c(
      "10" = "#006400", "20" = "#FFBB22", "30" = "#00CF75",
      "40" = "#D2B48C", "50" = "#FA0000", "60" = "#B4B4B4",
      "70" = "#FFFF4C", "80" = "#0064C8", "90" = "#0096A0",
...
ggplot() +
  ...
  guides(
    color = guide_legend(
      override.aes = list(
        size = 5,
        shape = 21,           # Shape with fill + border (21 = filled circle)
        fill = c("black", "gray30"),  # Inner fill colors
        color = "white",      # Border color (white outline)
...
ggsave("img/esa_landcover_study_area_with_animals_adj.png",
         bg = "#2D2D2D",
         width = 10, height = 6,
         dpi = 300)
